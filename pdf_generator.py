...
def _styles() -> dict:
    ...
    return {
        "biz_name": ps("biz_name", fontSize=18, textColor=C_PRIMARY,
                       fontName="Helvetica-Bold", alignment=TA_RIGHT),
        "biz_sub":  ps("biz_sub",  fontSize=9,  textColor=C_TEXT,
                       fontName="Helvetica", alignment=TA_RIGHT),
        "banner_l": ps("banner_l", fontSize=14, textColor=C_WHITE,
                       fontName="Helvetica-Bold", alignment=TA_LEFT),
        "banner_r": ps("banner_r", fontSize=10, textColor=C_WHITE,
                       fontName="Helvetica", alignment=TA_RIGHT),
        "sec_hdr":  ps("sec_hdr",  fontSize=9,  textColor=C_WHITE,
                       fontName="Helvetica-Bold", alignment=TA_LEFT),
        "label":    ps("label",    fontSize=7,  textColor=C_GRAY,
                       fontName="Helvetica"),
        "value":    ps("value",    fontSize=9,  textColor=C_TEXT,
                       fontName="Helvetica"),
        "th":       ps("th",       fontSize=9,  textColor=C_WHITE,
                       fontName="Helvetica-Bold", alignment=TA_CENTER),
        "td":       ps("td",       fontSize=9,  textColor=C_TEXT,
                       fontName="Helvetica"),
        "td_c":     ps("td_c",     fontSize=9,  textColor=C_TEXT,
                       fontName="Helvetica", alignment=TA_CENTER),
        "td_r":     ps("td_r",     fontSize=9,  textColor=C_TEXT,
                       fontName="Helvetica", alignment=TA_RIGHT),
        "sub_l":    ps("sub_l",    fontSize=9,  textColor=C_TEXT,
                       fontName="Helvetica-Bold", alignment=TA_RIGHT),
        "tot_l":    ps("tot_l",    fontSize=11, textColor=C_WHITE,
                       fontName="Helvetica-Bold", alignment=TA_RIGHT),
        "tot_v":    ps("tot_v",    fontSize=11, textColor=C_WHITE,
                       fontName="Helvetica-Bold", alignment=TA_RIGHT),
        "footer":   ps("footer",   fontSize=7,  textColor=C_GRAY,
                       fontName="Helvetica", alignment=TA_CENTER),
    }
